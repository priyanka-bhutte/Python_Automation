...
# len(sys.argv)     2    
# ReadFile.py file was present in study directory and Demo directory
# Output:
# C:\Users\Priyanka\Desktop\Python_2024\26-05-2024\drive-download-20240526T181700Z-001>python DirectoryAutomation11.py Study ReadFile.p
# y
# ---------------- Directory Watcher -------------------
# File gets deleted
# File gets deleted
